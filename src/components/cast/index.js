    ...
    return (
      ...
      <div className='titleContainer notSplash'>
        ...
        <div className='castCard'>
          ...
          stylish of our bunch. Don&#39;t let his impeccable taste in fashion and well-coiffed hair fool you! Adrian is 100% certified N-E-R-D. When not making others as fashionable and stylish as himself, he puts his computer science degree to good use by designing websites and phone apps. Much like Gad, our plucky Tortle Rogue attorney, Adrian knows how to lighten the mood and entertain everyone around him.
          </p>
        </div>
        <div className='castCard'>
          <h1>CAST 1</h1>
